...
def sb_print(val: str):
    print("\033[93m[\033[01mSync Bridge\033[00m\033[93m]\033[00m {}" .format(val))
    ...
    def invoke(self, args, tty):
        ...
        try:
            ...
            while True:
                ...
                leader_regs = decode_reg_values(self.sock.recv(1024 * 4).decode())
    ...
    def invoke(self, args, tty):
        ...
        try:
            ...
            while True:
                ...
                follow_regs = decode_reg_values(self.client_sock.recv(1024 * 4).decode())
                # compare
